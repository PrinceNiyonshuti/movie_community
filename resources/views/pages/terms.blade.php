        ...
        <div class="container">
            <div class="row ipad-width">
                ...
                <div class="block block-text">
                    ...
                    <p>Unless your copying of the content is for your own study purposes, this exception is unlikely to apply if multiple copies are made for more than one person to use for the same purpose, e.g. hand-outs for a class of students.</p>
                    <p><strong>(b) Fair dealing for the sole and non-commercial purpose of illustration for instruction (Section 32)</strong></p>
                    <p>If you are a teacher, pupil or parent of a pupil, you may be allowed to copy content in the course of teaching or being taught, or of preparing for teaching for being taught. You will need to give "sufficient acknowledgement" which means identifying the work, by its title or other description, and the author of the work. To acknowledge the author of a film you may need to identify all of the following: the author of the screenplay, the author of any underlying work such as a novel, the principal director, the production company and the author of the music. Other copyright works included in a film, such as songs or artwork, will also need to be acknowledged where relevant.</p>
                ...
                <div class="block block-text">
                    ...
                    <h2 class="terms-header">Proper Law </h2>
                    ...
                    <h2 class="terms-header">Claims of Infringement</h2>
